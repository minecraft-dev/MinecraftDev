...
object QuiltModuleType : AbstractModuleType<QuiltModule>("", "") {

    private const val ID = "QUILT_MODULE_TYPE"

    val IGNORED_ANNOTATIONS = emptyList<String>()
    val LISTENER_ANNOTATIONS = emptyList<String>()

    override val platformType = PlatformType.QUILT
    ...
    override fun generateModule(facet: MinecraftFacet) = QuiltModule(facet)
}
