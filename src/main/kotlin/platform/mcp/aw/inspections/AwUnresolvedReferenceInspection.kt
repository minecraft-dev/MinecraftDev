...
class AwUnresolvedReferenceInspection : LocalInspectionTool() {

    override fun getStaticDescription(): String? = "Reports unresolved AW targets."

    override fun buildVisitor(
        holder: ProblemsHolder,
        isOnTheFly: Boolean
    ): PsiElementVisitor = object : AwVisitor() {
