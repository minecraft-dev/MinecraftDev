...
class QuiltLoomDecompileSourceProvider : AttachSourcesProvider {
    override fun getActions(
        ...
        val loomData = GradleUtil.findGradleModuleData(module)?.children
            ?.find { it.key == QuiltLoomData.KEY }?.data as? QuiltLoomData
            ?: return emptyList()
    ...
    private class DecompileAction(val decompiler: QuiltLoomData.Decompiler) :
