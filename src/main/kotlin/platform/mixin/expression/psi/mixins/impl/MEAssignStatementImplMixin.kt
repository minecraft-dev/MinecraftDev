...
abstract class MEAssignStatementImplMixin(node: ASTNode) : MEStatementImpl(node), MEAssignStatementMixin {
    override val targetExpr get() = firstChild as MEExpression
}
