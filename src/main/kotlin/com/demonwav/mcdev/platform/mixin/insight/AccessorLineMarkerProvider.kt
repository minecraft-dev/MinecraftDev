...
class AccessorLineMarkerProvider : LineMarkerProviderDescriptor(), GutterIconNavigationHandler<PsiIdentifier> {

    companion object {
        private val ICON: Icon = MixinAssets.SHADOW
        private val TOOLTIP_FUNCTION = FunctionUtil.constant<Any, String>("Go to Accessor element")
    }

    override fun getName() = "@Accessor line marker"
    ...
    override fun getLineMarkerInfo(element: PsiElement): LineMarkerInfo<PsiIdentifier>? {
        ...
        // Check if @Accessor actually has a target
        element.findAccessorTarget() ?: return null
    ...
    override fun navigate(e: MouseEvent, elt: PsiIdentifier) {
        ...
        val target = member.findAccessorTarget() ?: return
