...
class SpongeGetterFilterInfoFilter : HighlightInfoFilter {
    ...
    val expectedDescription = JavaErrorMessages.message("annotation.missing.attribute", "'value'")!!
    ...
    override fun accept(highlightInfo: HighlightInfo, file: PsiFile?): Boolean {
        ...
        return !(element.canonicalText == SpongeConstants.GETTER_ANNOTATION && highlightInfo.description == expectedDescription)
    }
}
