...
public class BungeeCordConstants {
    ...
    @NotNull public static final String BUNGEECORD_HANDLER_ANNOTATION = "net.md_5.bungee.event.EventHandler";
    @NotNull public static final String BUNGEECORD_EVENT_PRIORITY_CLASS = "net.md_5.bungee.event.EventPriority";
